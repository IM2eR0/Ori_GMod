...
hook.Add("HUDPaint", "UsainBolt", function()
	if LocalPlayer():Alive() and LocalPlayer():HasAbility("桑拿人") and LocalPlayer():OnGround() then
...
hook.Add("GetFallDamage", "AvoidFallUsain", function(Player, Speed)
	if Player:HasAbility("桑拿人") then return CalculateBaseFallDamage( Speed )/2 end
end)

Abilities.Register("桑拿人", [[勇敢勇敢我的朋友~
    只要你保持奔跑，你会越跑越快
	跑得越快跳的越高
	摔落伤害减半]], "1f9d6-1f3ff-200d-2642-fe0f")